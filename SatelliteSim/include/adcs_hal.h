...
extern "C" {
    ...
    /// Sensor readings passed into the control algorithm each step
    typedef struct {
    ...
    /// The core control entry point: the embedded code implements this.
    ...
    /// Switch between the two control modes at runtime
